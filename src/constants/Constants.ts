...
export const constentString = {
  EMPTY_LIST_MESSAGE:
    'Currerntly no employees added in the meet\nPlease add employee in meet',
  EMAIL: 'Email',
  NAME: 'Name',
  AGE: 'Age',
  GENDER: 'Gender',
  REMOVE_FROM_MEET: 'Remove from Meet',
  ADD_TO_MEET: 'Add to Meet',
  NO_OF_EMP_JOINED: 'Number of employee joined',
